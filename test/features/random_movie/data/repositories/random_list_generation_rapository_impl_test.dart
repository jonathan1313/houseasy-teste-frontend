...
import 'package:houseasy_teste_frontend/app/features/random_movie/data/repositories/random_list_generation_repository_impl.dart';
...
void main() {
  ...
  final RandomListGenerationUsecase randomListGenerationRapository = RandomListGenerationUsecaseImpl(RandomListGenerationRepositoryImpl(HttpClientServiceImpl(Client())));
